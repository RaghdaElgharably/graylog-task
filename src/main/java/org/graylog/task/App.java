...
/**
 * This is the entry for the application. the app takes an absolute file path as input, parse it,
 * validates it versus a schema and logs it to graylog. To start the app, you need to run the class
